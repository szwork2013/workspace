<?php
// Fixed    : L394
// Disabled : L363 ~ 366 - one the comment killed.
// Disabled : L403 ~ 408 - some scalars are killed.
// Disabled : L721 ~ 727 - anchor & alias are killed.
...
*/
    if (preg_match('/^("(.*)"|\'(.*)\')/',$value,$matches)) {
      ...
      $array = array();
      foreach ($explode as $v) {
        $array = array_merge($array,array($this->_toType($v)));
      }
      $value = $array;
