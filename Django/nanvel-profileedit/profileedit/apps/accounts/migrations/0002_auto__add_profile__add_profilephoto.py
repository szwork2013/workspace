...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_profilephoto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', to=orm['accounts.Profile'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'accounts', ['ProfilePhoto'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_profilephoto')
    ...
    models = {
        ...
        u'accounts.profilephoto': {
            'Meta': {'object_name': 'ProfilePhoto'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': u"orm['accounts.Profile']"}),
